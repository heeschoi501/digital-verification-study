...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , op_start_btn{vlSymsp->TOP.op_start_btn}
    , interlock_sig{vlSymsp->TOP.interlock_sig}
    , current_process{vlSymsp->TOP.current_process}
    , source_status{vlSymsp->TOP.source_status}
    , env_status{vlSymsp->TOP.env_status}
    , rootp{&(vlSymsp->TOP)}
{
